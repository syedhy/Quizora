export const QUESTION_FILE = '/questions.txt';
...
export const modes: Array<{
...
}> = [
  {
    ...
    title: 'Classic',
    kicker: 'No clock',
    description: 'Move with intent, reveal the answer, and finish the full set.',
  },
  {
    id: 'timed',
    title: 'Timed',
    kicker: '30s each',
    description: 'A clean countdown on every question. Timeouts move forward automatically.',
  },
  {
    id: 'survival',
    title: 'Survival',
